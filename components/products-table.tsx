              ...
              {isLoading ? (
                ...
                products.map((product) => (
                  <tr key={product._id} className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">{product.MARCA || '-'}</td>
                    <td className="px-6 py-4 text-sm text-foreground">{product.UNIDADE || '-'}</td>
                    <td className="px-6 py-4 text-sm text-foreground">{formatCurrency(product.VLRCOMERC)}</td>
