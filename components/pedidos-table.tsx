              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-green-50">
                    <TableHead className="font-semibold text-green-800">NUNOTA</TableHead>
                    <TableHead className="font-semibold text-green-800">Parceiro</TableHead>
                    <TableHead className="font-semibold text-green-800">Vendedor</TableHead>
                    <TableHead className="font-semibold text-green-800">Data Negociação</TableHead>
                    <TableHead className="font-semibold text-green-800 text-right">Valor</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
