    ...
    <div className="space-y-6">
      <Card className="border-green-200 shadow-sm">
        <CardHeader className="bg-gradient-to-r from-green-50 to-green-100 border-b border-green-200">
          <CardTitle className="text-green-800">Cabeçalho do Pedido</CardTitle>
          <CardDescription className="text-green-700">Informações principais do pedido de venda</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6 bg-white p-6">
          {/* Seção: Dados do Parceiro */}
          <div className="space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-green-200">
              <div className="w-1 h-6 bg-green-600 rounded"></div>
              <h3 className="text-lg font-semibold text-green-800">Dados do Parceiro</h3>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-green-200">
              <div className="w-1 h-6 bg-green-600 rounded"></div>
              <h3 className="text-lg font-semibold text-green-800">Dados da Nota</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={pedido.TIPMOV} onValueChange={(value) => setPedido({ ...pedido, TIPMOV: value })}>
                  <SelectTrigger className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="codemp" className="text-gray-700 font-medium">Empresa *</Label>
                <Input
                  id="codemp"
                  value={pedido.CODEMP}
                  onChange={(e) => setPedido({ ...pedido, CODEMP: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="codcencus" className="text-gray-700 font-medium">Centro de Resultado</Label>
                <Input
                  id="codcencus"
                  value={pedido.CODCENCUS}
                  onChange={(e) => setPedido({ ...pedido, CODCENCUS: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="codvend" className="text-gray-700 font-medium">Código do Vendedor</Label>
                <Input
                  id="codvend"
                  value={pedido.CODVEND}
                  onChange={(e) => setPedido({ ...pedido, CODVEND: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="codnat" className="text-gray-700 font-medium">Código de Natureza</Label>
                <Input
                  id="codnat"
                  value={pedido.CODNAT}
                  onChange={(e) => setPedido({ ...pedido, CODNAT: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50"
                />
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 pb-2 border-b border-green-200">
              <div className="w-1 h-6 bg-green-600 rounded"></div>
              <h3 className="text-lg font-semibold text-green-800">Valores</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="codparctransp" className="text-gray-700 font-medium">Transportador</Label>
                <Input
                  id="codparctransp"
                  value={pedido.CODPARCTRANSP}
                  onChange={(e) => setPedido({ ...pedido, CODPARCTRANSP: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-gray-50"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="ordemcarga" className="text-gray-700 font-medium">Ordem de Carga</Label>
                <Input
                  id="ordemcarga"
                  value={pedido.ORDEMCARGA}
                  onChange={(e) => setPedido({ ...pedido, ORDEMCARGA: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500"
                />
              </div>
      ...
      <Card className="border-green-200 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-green-50 to-green-100 border-b border-green-200">
          <div>
            <CardTitle className="text-green-800">Itens do Pedido</CardTitle>
            <CardDescription className="text-green-700">Adicione os produtos ao pedido</CardDescription>
          </div>
          <Button onClick={abrirModalNovoItem} size="sm" className="bg-green-600 hover:bg-green-700 text-white">
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto border-green-200">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label className="text-gray-700 font-medium">Qtd Barras</Label>
                <Input
                  type="number"
                  value={itemAtual.AD_QTDBARRA || 0}
                  onChange={(e) => setItemAtual({ ...itemAtual, AD_QTDBARRA: parseFloat(e.target.value) || 0 })}
                  min="0"
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={itemAtual.CODVOL || 'UN'}
                  onChange={(e) => setItemAtual({ ...itemAtual, CODVOL: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label className="text-gray-700 font-medium">Cód. Alíq. ICMS</Label>
                <Input
                  value={itemAtual.IDALIQICMS || '0'}
                  onChange={(e) => setItemAtual({ ...itemAtual, IDALIQICMS: e.target.value })}
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500"
                />
              </div>

              <div className="space-y-2">
                <Label className="text-gray-700 font-medium">Controle/Lote</Label>
                <Input
                  value={itemAtual.CONTROLE || ''}
                  onChange={(e) => setItemAtual({ ...itemAtual, CONTROLE: e.target.value })}
                  placeholder="Informe o lote (se aplicável)"
                  className="border-gray-300 focus:border-green-500 focus:ring-green-500"
                />
              </div>
            </div>
